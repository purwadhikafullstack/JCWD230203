...
const roomDetail = () => {
  return (
    ...
    <div className="flex flex-grow shadow-xl bg-white overflow-scroll">
    <div className="flex-grow flex-col">
    <div className="flex flex-grow items-center space-x-1">
                <p className="font-bold flex-grow text-xl">Hotel Plaza Venice</p>
            ...
            <div className="flex flex-row space-x-1 text-blue-600 my-2">
                <p className=" font-semibold text-xs">Feb 18 - 25, 2022, 2 adults, 1 room</p>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
