                ...
                <div className="form bg-gray-600 max-w-md mx-auto p-6 rounded-lg">
                  ...
                  <div className="flex flex-shrink-0 flex-wrap items-center justify-end rounded-b-md border-t-2 border-neutral-100 border-opacity-100 p-4 dark:border-opacity-50">
                    ...
                    <button
                      ...
                      data-te-ripple-color="light"
                    >
                      {loading ? <div className="h-fit flex justify-center"><Loader /></div> :  "Save Changes"}
                    </button>
                  </div>
                </div>
              </form>
              ...
              >
                <div className="form bg-gray-600 max-w-md mx-auto p-6 rounded-lg">
                  ...
                  <div className="flex flex-shrink-0 flex-wrap items-center justify-end rounded-b-md border-t-2 border-neutral-100 border-opacity-100 p-4 dark:border-opacity-50">
                    ...
                    >
                     {loading ? <div className="h-fit w-full flex justify-center"><Loader /></div> :  "Save Changes"}
                    </button>
                  </div>
                </div>
              </form>
            ...
            <div className="flex flex-shrink-0 flex-wrap items-center justify-evenly rounded-b-md border-t-2 border-neutral-100 border-opacity-100 p-4 dark:border-opacity-50">
              ...
              > */}
                <button
                  ...
                  onClick={bookedRoom}
                >
                  {loading ? <div className="h-fit flex justify-center"><Loader /></div> :  "Checkout"}
                </button>
              {/* </Link> */}
            </div>
          </div>
